...
from .views import BlogList, BlogDetail, LoginToBlog, CreateBlog, EditBlog, DeleteBlog, AddCategory, CategoryView, CategoryList, LikeView, AddComment
from . import views
...
urlpatterns = [
    ...
    path('blog/<int:pk>/comment', AddComment.as_view(), name='add_comment'),
]
